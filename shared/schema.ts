...
export const applications = pgTable("applications", {
  ...
  notes: text("notes"),
  requiredDocuments: text("required_documents"), // JSON array of required document types
  submittedDocuments: text("submitted_documents"), // JSON object mapping document types to file paths
